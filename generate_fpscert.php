...
$resident = $db
  ...
  ->select([
    ...
    "birthdate" => "residents.birthdate" // Ensure birthdate is selected
  ])
  ->exec();

if ($resident) {
  // Check if 'birthdate' exists before calculating age
  if (isset($resident['birthdate'])) {
    $birthDate = new DateTime($resident['birthdate']);
    $today = new DateTime();
    $age = $today->diff($birthDate)->y;
  } else {
    $age = "N/A"; // Or handle the case where birthdate is missing
  }
}
              ...
              <div class="col-md-12">
                  ...
                  <div class="card-body m-5" id="printThis">
                    <div class="d-flex flex-wrap justify-content-around">
                      ...
                      <div class="text-center">
                        ...
                        <h1 class="fw-bold mb-0" style="font-size: 18px; font-family: Times New Roman;"><?= ucwords($brgy) ?></h1>
                      </div>
                      <div class="text-center">
                    ...
                    <h3 class="mt-3" style="text-indent: 40px; font-size: 15px;">This is to certify that
                      <b><u><?= fullname($resident) ?></u></b>, <span class="fw-bold" style="font-size:15px"><?= $age ?> years old</span>, resident of <span class="fw-bold"
                    ...
                    <h3 class="mt-3" style="text-indent: 40px; font-size:15px">Also certify that <u><b>
                          <?= fullname($resident) ?></b></u> is a Pantawid Pamilya Pilipino Program
                      beneficiary (4ps). </h3>

                    <h3 class="mt-3" style="text-indent: 40px; font-size:15px">Certified Further that the name stated above is now
                      residing in <?= ucfirst($resident['address']) ?>. </h3>

                    <h3 class="mt-3" style="text-indent: 40px; font-size:15px">Issued this <?= Carbon::now()->toDateString() ?> at
                      <span class="fw-bold" style="font-size:15px"><?= ucwords($brgy) ?>, <span class="fw-bold"
                          style="font-size:15px"><?= ucwords($town) ?>, <span class="fw-bold"
                            style="font-size:15px"><?= ucwords($province) ?>.</span></span></span></h3>
                    </h3>
                    <br><br>
                ...
                <div class="col-md-10">
                  <div class="p-3 text-right mr-10" style="margin-top:35px">
                    ...
                    <p class="mt-0" style="font-size: 13px; text-align: right; text-indent: left;">PUNONG BARANGAY  </p><br><br>
