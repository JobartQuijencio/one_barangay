...
$revenue = (function () use ($db): mixed {
  return $db
      ->from('payments')
      
      ->leftJoin("users", "users.id", "payments.user_id")
      ->leftJoin("residents", "residents.id", "payments.resident_id")
...
<html lang="en">
  ...
  <head>
    ...
    <title>Barangay Collection Payment</title>
  </head>
...
<tr>
    ...
    <td>
        <?php 
        // Check if recipient name fields exist and are not null
        if (!empty($row['firstname']) || !empty($row['middlename']) || !empty($row['lastname'])) {
            echo fullname($row);
        } else {
            echo " Made by Admin"; // Display a placeholder for missing data
        }
        ?>
    </td>
    <td><?= $row['details'] ?></td>
