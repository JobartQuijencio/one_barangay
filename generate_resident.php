                ...
                <div class="card">
                  ...
                  <div class="card-body m-5" id="printThis">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          <h7 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Sitio/Zone:</h7>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                          <input type="text" class="form-control fw-bold" style="font-size:15px"
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group row">
                          <h7 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Identified as Household member</h7>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                          <input type="text" class="form-control fw-bold" style="font-size:15px"
