...
<head>
    ...
    <title>Barangay Sitio and Zone</title>
</head>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">Barangay Sitio's and Zone's</div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit" onclick="editPurok(this)" data-name="<?= $row[
                                                                    	"name"
                                                                    ] ?>" data-details="<?= $row[
	"details"
] ?>" data-id="<?= $row["id"] ?>">
                                                                    ...
                                                                    <a type="button" data-toggle="tooltip" href="model/remove_purok.php?id=<?= $row[
                                                                    	"id"
                                                                    ] ?>" onclick="return confirm('Are you sure you want to delete this Sitio/Zone?');" class="btn btn-link btn-danger" data-original-title="Remove">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create Sitio/Zone</h5>
            ...
            <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Sitio/Zone</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
